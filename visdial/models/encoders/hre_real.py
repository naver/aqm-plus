...
class Encoder(nn.Module):
    ...
    def exportParam(self):
        return (self.imageEmbed, self.captionEmbed, self.questionEmbeds, \
                self.answerEmbeds, self.factEmbeds, self.dialogHiddens, \
                self.questionRNNStates, self.dialogRNNInputs, self.questionTokens, \
                self.questionLens, self.answerTokens, self.answerLengths)

    
    def importParam(self, params):
        self.imageEmbed, self.captionEmbed, self.questionEmbeds, \
        self.answerEmbeds, self.factEmbeds, self.dialogHiddens, \
        self.questionRNNStates, self.dialogRNNInputs, self.questionTokens, \
        self.questionLens, self.answerTokens, self.answerLengths = params
